...
export default function LandingPage() {
    ...
    return (
        <>
            ...
            <div className={`flex flex-col justify-evenly relative bg-${theme}-700 items-center bg-fixed text-white h-[70vh] md:h-[100vh] text-4xl `}>
                ...
                {/* Social Icons             */}
                <motion.div transition={{ duration: 1, when: 'beforeChildren', staggerChildren: 0.2, delayChildren: 0.2, delay: i + 4 }} className="icons z-40 grid sm:grid-cols-1 gap-5 sm:gap-3 grid-cols-2 bottom-5 left-6 sm:bottom-14 sm:left-7 absolute">
