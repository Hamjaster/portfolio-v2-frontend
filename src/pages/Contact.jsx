            ...
            <div className={`bg-${theme}-700 z-40  relative mb-5 text-white w-full flex flex-col px-5 sm:px-10 md:px-14 pt-14 justify-center`}>
                ...
                <FadeUp
                    text={<div className="text z-10 ">
                        ...
                        <h3 className='text-sm sm:text-xl md:text-2xl font-thin mt-3'>Have any idea? Got any query? Wanna meet me?
                    ...
                    <FadeUp
                        text={
                            <div class="w-full pt-3 pb-12">
                                <button type="submit" class={`w-2/5 sm:w-[16%] md:w-[19%] rounded-md bg-white text-${theme}-700 px-4 py-2  duration-50 focus:outline-none font-semibold hover:bg-slate-200 transition-all hover:text-${theme}-700 text-xl cursor-pointer`}>
                                    Send
                                </button>
                            </div>
                        }
